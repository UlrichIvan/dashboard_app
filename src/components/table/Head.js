...
import { v4 } from 'uuid'
import { removeRowsSelected, setRowsSelected, updateRowsByPeriodAndPage } from '../../actions/paginationActions';

function Head() {

    const { rows, headers, period, selected } = useSelector(state => state.pagination)
    ...
    const handlerChecked = useCallback((e) => {
